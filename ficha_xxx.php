                    ...
                    <div class="chart tab-pane active" id="modelo" style="position: relative; border: solid 0px purple;">
                        ...
                        <form id="fmodelo">
                                        ...
                                        <label>Linea</label><div id="dv_linea">
                                            <select class="custom-select" id="cmblinea" name="ncmblinea" tabindex="9">
                                                ...
                                                <optgroup>
                                                    ...
                                                    while(!$rs->EOF){
                                                        echo "<option value='".$rs->fields['ID_LINEA']."'>".$rs->fields['LINEA']."</option>";
                                                        $rs->MoveNext();
                                                    }
                                                    ?>
                                                </optgroup>
                            ...
                            <div class="row">
                                ...
                                <div id="dv_duplicar" class="col-md-1" style="display: none;"><button type="button" class="btn btn-success" id="btn_duplicar" onclick="Duplicar();">Duplicar</button></div>
                                <div class="col-md-5"></div>
                            </div>
                        </form>
                    </div>
...
<script type="text/javascript">
    ...
    function Registrar_Medidas() {
        ...
        if($('#tficha').val()==''){//Validacion para saber si registramos o actualizamos
            ...
            * */
            ...
            for(var j = 1; j<16; j++){//rango de medidas
                if($('#m'+j).val() != 0){
            ...
            $.ajax({//Hacemos ajax para actualizar medidas
                ...
                success: function(data){
                    if(data.search('Error')!=1){
                        var med = "";
                        var model = $('#tcorrida').val().split('|');//separa el string por talla
                        for(var j=parseInt(ft[0])+1; j<16; j++){//rango de medidas
                            if($('#md_'+j).val() != 0){
                                for(var i=0; i<model.length-1; i++) {
    ...
    function Numerico(e){
        ...
        if(letras.indexOf(tecla)==-1){
            var especiales = [8,9,233,237,243,250,32];
