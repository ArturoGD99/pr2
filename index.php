    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview">
                <a href="#" id="habilitacion" class="nav-link" onclick="activar_opcion('habilitacion'); Submenu('sub_ficha'); Ajax_Dinamico('habilitacion/habilitacion.php','centro','');"><i class="nav-icon fas fa-solid fa-tag"></i><p>Habilitacion<i class="right fas fa-angle-left"></i></p></a>
            </li>
            <li class="nav-item has-treeview">
                <a href="#" id="laboratorio" class="nav-link" onclick="activar_opcion('laboratorio'); Submenu('sub_ficha'); Ajax_Dinamico('laboratorio/laboratorio.php','centro','');"><i class="nav-icon fas fa-microscope"></i><p>Laboratorio<i class="right fas fa-angle-left"></i></p></a>
            </li>
           </ul>
      </nav>
    </div>
...
<script type="text/javascript" src="dist/js/responsive.bootstrap4.min.js"></script>
...
<script>
    ...
    function activar_opcion(op){
        ...
        $('#habilitacion').attr("class","nav-link");
        $('#laboratorio').attr("class","nav-link");
